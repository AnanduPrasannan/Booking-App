...
import BookingDetailSummary from '../forms/BookingForm/BookingDetailSummary'
...
const Booking = () => {
  ...
  return (
    <div className='grid  md:grid-cols-[1fr_2fr] gap-4 '>
            ...
            />
            {currentUser &&  paymentIntentData && ( <Elements stripe={stripePromise} options={{clientSecret:paymentIntentData.clientSecret}}>
